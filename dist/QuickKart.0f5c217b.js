...
//! HERE THIS IS THE MAIN TS FILE WHERE FIRST I NEED TO CALL THE FUNCITON TO DISPALY THE PRODUCTS: 
...
var _displayProduct = require("./DisplayProduct");
var _showMenu = require("./ShowMenu");
//! IN FUTURE TRY OT IMPLEMT THE FEATURES OF SEARCHING AND SORTING....OF PRODUCT{FOR SURE...}
(0, _displayProduct.DisplayProducts)((0, _productDataJsonDefault.default));
//! HERE I NEED TO ALSO CALL THE SHOW MENU FUNCTION, TO DISPLAY THE NAVLIST, ON A SMALL SCREEN SIZES: 
(0, _showMenu.ShowMenu)();

},{"../Api/ProductData.json":"cDykq","./DisplayProduct":"8kLxa","./ShowMenu":"2j4SI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8kLxa":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DisplayProducts", ()=>DisplayProducts);
var _addToCart = require("./addToCart");
var _productCounterPage = require("./ProductCounterPage");
...
const DisplayProducts = (CurrProd)=>{
    ...
    CurrProd.forEach((currItem)=>{
        ...
        ProductClone.querySelector('.Product-Price').textContent = String(`\u{20B9}${price}`);
        ProductClone.querySelector('.Product-Actual-Price').textContent = String(` \u{20B9}${price * 1.2}`);
        ...
        ProductClone.querySelector('.stockcounter').addEventListener('click', (event)=>(0, _productCounterPage.ProductCounterPage)(id, stock, event));
        ...
        ProductClone.querySelector('.addToCart').addEventListener('click', (event)=>(0, _addToCart.addToCart)(id, stock, event));
        // ONCE VALUES OF API, IS INSERTED IN PRODUCT CLONE, THEN WE NEED TO APPEND WHOLE CARD DATA TO PRODUCTCONTAINERS:
        ProductContainer?.append(ProductClone);
    });
};

},{"./addToCart":"9b14g","./ProductCounterPage":"9yuGX","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9b14g":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _getCartProductLS.getCartProductLS)(); //HERE I CAN GIVE THIS FUNCTINO AS DEFAULT , SO THAT IT CALLS THE LOCAL STORAGE DATA, WHEN WE OPEN THE PAGE.
const addToCart = (id, stock, event)=>{
    ...
    const LocalStorageArray = (0, _getCartProductLS.getCartProductLS)();
    ...
    if (existingProduct && quantity > 1) {
        ...
        (0, _toast.ShowToast)("add", id);
    }
    // IF EXISTING PRODUCT IS THERE, NO NEED TO ADD TO CART:
    if (existingProduct) // alert("Product Already Exists...");
    return false;
    //--------------------------------------------------------
    ...
    LocalStorageArray.push({
        ...
        price,
        quantity
    }); //PUSHING ALL THE REQUIRED VALUES TO AN ARRAY.
    ...
    (0, _updateCartNumber.UpdateCartNumber)(LocalStorageArray);
};

},{"./getCartProductLS":"8wITc","./Toast":"htZdv","./UpdateCartNumber":"eT5u3","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9yuGX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ProductCounterPage", ()=>ProductCounterPage);
const ProductCounterPage = (id, stock, event)=>{
    //NOW HERE, OUR FIRST RESPONSIBILLITY IS TO CHECK WHICH CARD IS CLICKED BY THE USER, ONLY THAT  CARD WILL BE AFFECTED WHENEVER WE DO INCREMENT OR DECREMENT. 
    const currentCard = document.querySelector(`#card${id}`);
    // console.log(currentCard);
    ...
    //NOW HERE I NEED TO PERFORM THE EVENT DELEGATION ON INCREMENT AND DECREMENT BUTTON: 
    const target = event.target;
    //FOR INCREMENT CLASS BUTTON: 
    if (target.className === "Count-Increment") {
        if (Quantity < stock) Quantity += 1;
        else if (Quantity == stock) Quantity = stock;
    }
    //FOR DECREMENT CLASS BUTTON:
    if (target.className === "Count-Decrement") {
        if (Quantity > 1) Quantity -= 1;
    }
    //NOW UPDATING THE FINAL QUANTITY VALUES; 
    ProductQuantity.innerText = String(Quantity);
    ProductQuantity?.setAttribute("total-quantity", String(Quantity));
    return Quantity;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2j4SI":[function(require,module,exports,__globalThis) {
//HERE I NEED TO DISPLAY ALL NAVLIST ELEMENT, WHICH I HIDE FOR THE MOBILE SCREEN SIZE, SO WHENEVER A USER CLICK ON THE HAMBARS, I WANT TO MAKE DISPLAY AS BLOCK, SO THAT IT CAN BE VISIBLE TO PHONE SCREEN: 
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ShowMenu", ()=>ShowMenu);
let navmenu = document.querySelector('header .container .navbar1 .navlist');
//TAMING THE REFERENCE OF HAMBARS, THAT TOGGLE THE MENU LIKE SHOW/HIDE: 
let hambar = document.querySelector('.bar');
const ShowMenu = ()=>{
// HERE I NEED TO WRITE THE LOGIC FOR HAMBARS...
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["klwky","8Ekvk"], "8Ekvk", "parcelRequire94c2", {})

//# sourceMappingURL=QuickKart.0f5c217b.js.map
